...
@section('title', __('contact.contact_us'))
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="p-3 p-lg-5 border">
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label for="c_fname" class="text-black">{{ __('contact.first_name') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="c_fname" name="c_fname">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="c_lname" class="text-black">{{ __('contact.last_name') }} <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="c_email" class="text-black">{{ __('contact.email') }} <span
                                                    class="text-danger">*</span></label>
    ...
    <<<<<<< HEAD @endsection=======<div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="h3 mb-3 text-black">{{ __('contact.get_in_touch') }}</h2>
...
@endsection
    >>>>>>> 531c54b1a8d295221a6b663234a2446a60b087ab